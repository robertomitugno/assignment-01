...
public class BoidsSimulation {
	...
	final static String sequential_performance = "./src/main/java/pcd/ass01/sequential_performance.csv";
	final static String sequential_avg_performance = "./src/main/java/pcd/ass01/sequential_avg_performance.csv";
	...
	private static void saveDetailedResultsToCSV(
		...
		try (FileWriter writer = new FileWriter(BoidsSimulation.sequential_performance)) {
	...
	private static void saveAverageResultsToCSV(
		...
		try (FileWriter writer = new FileWriter(BoidsSimulation.sequential_avg_performance)) {
