...
public class BoidsSimulation {
    ...
    final static String virtualthread_performance = "./src/main/java/pcd/ass01/performance/virtualthread_performance.csv";
    final static String virtualthread_avg_performance = "./src/main/java/pcd/ass01/performance/virtualthread_avg_performance.csv";
    ...
    private static void saveDetailedResultsToCSV(
        ...
        try (FileWriter writer = new FileWriter(BoidsSimulation.virtualthread_performance)) {
    ...
    private static void saveAverageResultsToCSV(
        ...
        try (FileWriter writer = new FileWriter(BoidsSimulation.virtualthread_avg_performance)) {
