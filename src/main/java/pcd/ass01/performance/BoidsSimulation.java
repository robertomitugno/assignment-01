...
public class BoidsSimulation {
    ...
    final static String task_performance = "./src/main/java/pcd/ass01/performance/task_performance.csv";
    final static String task_avg_performance = "./src/main/java/pcd/ass01/performance/task_avg_performance.csv";
    ...
    private static void saveDetailedResultsToCSV(
        ...
        try (FileWriter writer = new FileWriter(BoidsSimulation.task_performance)) {
    ...
    private static void saveAverageResultsToCSV(
        ...
        try (FileWriter writer = new FileWriter(BoidsSimulation.task_avg_performance)) {
